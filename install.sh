...
echo -e "  ${DIM}1.${RESET} .prism.local.json           ${DIM}Your personal overrides (gitignored)${RESET}"
echo -e "  ${DIM}2.${RESET} .prism.json                 ${DIM}Repo config (commit for your team)${RESET}"
